...
#include "../Shar/communication/rx_commands.h"
#include "../main/settings.h"
#include "device/device.h"
#include "serialComPort/mainSerialPort.h"
#include "../Pylt/communication/rx_commandsPylt.h"
...
public:
    ...
    void setRx_commands_Pylt(Rx_commands_Pylt *newRx_commands_Pylt);
...
private:
    ...
    Rx_commands_Pylt *_rx_commandsPylt = nullptr;
